...
public class TankScreen extends AbstractContainerScreen<TankMenu> implements GuiEventListener {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(InfinityNexusMod.MOD_ID, "textures/gui/tank_gui.png");
    ...
    protected void renderBg(GuiGraphics guiGraphics, float pPartialTick, int pMouseX, int pMouseY) {
        ...
        fluidRenderer.render(guiGraphics, x+80, y+6, menu.blockEntity.getFluid());
    }
    ...
    protected void renderLabels(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY) {
        ...
        renderFluidAreaTooltips(pGuiGraphics,pMouseX,pMouseY, x, y, menu.blockEntity.getFluid(), 80,6, fluidRenderer);
