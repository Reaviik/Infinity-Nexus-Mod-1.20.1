...
public class FractalArmorModel extends GeoModel<FractalArmorItem> {
    ...
    public ResourceLocation getTextureResource(FractalArmorItem animatable) {
        ...
        ResourceLocation location = new ResourceLocation(InfinityNexusMod.MOD_ID, path);
        if (!resourceExists(location)) {
            location = new ResourceLocation(InfinityNexusMod.MOD_ID, "textures/models/armor/infinity.png");
        }
        return location;
    }
