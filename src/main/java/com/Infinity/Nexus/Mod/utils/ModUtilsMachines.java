...
public class ModUtilsMachines {
    ...
    public static void sendParticlePath(ServerLevel serverLevel, BlockPos posStart, BlockPos targetPos, double x, double y, double z) {
        ...
        for (int i = 0; i <= steps; i++) {
            ...
            serverLevel.sendParticles(ParticleTypes.SCRAPE, x1 + x, y1 + y, z1 + z, 1, 0, 0, 0, 0.01D);
        }
    }
