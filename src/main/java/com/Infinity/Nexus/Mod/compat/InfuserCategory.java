...
public class InfuserCategory implements IRecipeCategory<InfuserRecipes> {
    ...
    public static final ResourceLocation UID = new ResourceLocation(InfinityNexusMod.MOD_ID, "infuser");
    public static final ResourceLocation TEXTURE = new ResourceLocation(InfinityNexusMod.MOD_ID, "textures/gui/jei/infuser_gui.png");
